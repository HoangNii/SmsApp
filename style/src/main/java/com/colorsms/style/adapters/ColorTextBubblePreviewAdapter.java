...
public abstract class ColorTextBubblePreviewAdapter extends RecyclerView.Adapter<ColorTextBubblePreviewAdapter.ViewHolder> {
    ...
    public ColorTextBubblePreviewAdapter(Context context, View isCheck) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(isCheck.isSelected()){
            if(color== Style.Bubble.getBubbleTextReceivedColor()){
                holder.imgColor.setImageResource(R.drawable.ic_check);
            }else {
                holder.imgColor.setImageResource(0);
            }
        }else {
            if(color== Style.Bubble.getBubbleTextSentColor()){
                holder.imgColor.setImageResource(R.drawable.ic_check);
            }else {
                holder.imgColor.setImageResource(0);
            }
