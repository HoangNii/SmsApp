...
public abstract class ColorPreviewAdapter extends RecyclerView.Adapter<ColorPreviewAdapter.ViewHolder> {
    ...
    private int[] colors = new int[]{
            ...
            Color.parseColor("#5FBEFE"),
            Color.parseColor("#665EFF"),
            Color.parseColor("#006837"),
            Color.parseColor("#C2272D"),
    };
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(color== Style.Home.getStyleColor()){
